...
echo "Buy Id =   ".$_SESSION['buyid'];
 mysql_query("update tbl_cart set payment_status='1' where cart_id='".$_SESSION['cid']."'");
  //ob_start();
                    ...
                    <table class="auto-style1">
                        <tr>
                            ...
                            <td class="auto-style32">
                                &nbsp;<input type="text"  runat="server" value="<?php echo "Craft Products Pvt Lmt";?>"/>
                            </td>
                        </tr>
                        <tr>
